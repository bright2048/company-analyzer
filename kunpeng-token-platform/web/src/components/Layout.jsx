...
const navItems = [
  { path: '/', label: '总览', icon: '📊' },
  { path: '/market', label: '模型超市', icon: '🏪', external: true },
  { path: '/subscriptions', label: '我的订阅', icon: '📋' },
  { path: '/keys', label: 'API密钥', icon: '🔑' },
  { path: '/plans', label: '钱包充值', icon: '💰' },
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center space-x-3">
            ...
            <Link to="/" className="text-xl font-bold text-blue-600 dark:text-blue-400">鲲鹏Token汇聚平台</Link>
          </div>
